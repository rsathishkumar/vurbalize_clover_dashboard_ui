          ...
          <div className="flex flex-col flex-grow w-full max-w-xl bg-white shadow-7xl rounded-lg overflow-hidden">
            ...
            <div className="flex flex-col flex-grow h-0 pt-4 pb-[76px] px-3 overflow-auto relative">
              ...
              <div className="flex mt-2 space-x-3 max-w-md items-end">
                ...
                <div>
                  <div className="bg-[#F1F1F1] py-4 px-5 rounded-r-[20px] rounded-tl-[20px] w-[290px]">
                    <span className="font-normal font-TimesNewRoman text-black text-base" dangerouslySetInnerHTML={{ __html: message }}>Hello Mike! How can I assist you today with Clover POS?</span>
                  </div>
                </div>
              </div>
              )
